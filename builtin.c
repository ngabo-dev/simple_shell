...
int _myexit(info_t *info)
{
	...
	if (info->argv[1])  /* If there is a dispute over leaving,*/
	{
 ...
 * @info: Arrangement with possible arguments. utilized to maintain
 *          continuous performance prototype.
 *  Return: Usually 0
 */
